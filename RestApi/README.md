...
- no id has to be sent. employee id is autogenerated
  ...
  "department":{"id":1}
  ```
![add-employee-postman](E:\ITI\Hr_Manager_Api\RestApi\images\addEmployee.png)
...
![add-new-day-postman](E:\ITI\Hr_Manager_Api\RestApi\images\addAttendance.png)

## Entity Relation Diagram

![ERD](E:\ITI\Hr_Manager_Api\RestApi\images\hrDiagram.png)
...
![test](E:\ITI\Hr_Manager_Api\RestApi\images\test.png)
